...
/**
 * NFVO Dashboard: consumes VnfStatusUpdatedEvent from the LCM service.
 * ---------------------------------------------------------------------------
 * Represents the boss (NFVO) in ETSI MANO. The LCM publishes state changes
 * to topic nfvo-vnf-notifications; this listener logs them as if updating
